...
def main():
    ...
    def get_1516_changes(statecode_list, new_df1):
        ...
        for statecode in statecode_list:
            ...
            for index, rows in emis_2015.iterrows(): 
                ...
                my_list =[rows.CO2_Emissions, rows.CLTCB, rows.NGTCB, rows.PMTCB] 
    ...
    changes_1516_df.columns = ['D_Emis','D_Coal_Cons', 'D_NatGas_Cons', 'D_Petrol_Cons']
    ...
    graph.write_png("decisiontree_emis_fossilfuels_A.png")
    ...
    changes_allyears_df.columns = ['D_Emis','D_Coal_Cons', 'D_NatGas_Cons', 'D_Petrol_Cons']

    #Output the dataframe to a csv file
    export_csv = changes_allyears_df.to_csv ('decisiontree_emis_fossilfuels_B_data.csv', index = 1, header=True) 
    ...
    graph = pydotplus.graph_from_dot_data(dot_data)  
    graph.write_png("decisiontree_emis_fossilfuels_B.png")
    ...
    #STEP 4: Compare the Y_pred with Y_actual, to get a true positive rate 
    print("Emisissions vs Fossil Fuels Decision Tree Accuracy:",metrics.accuracy_score(Y_actual, Y_pred))
...
if __name__ == '__main__':
    ...
    print("Calling decisiontree_emis_fossilfuels.py -> main() ")
    main()