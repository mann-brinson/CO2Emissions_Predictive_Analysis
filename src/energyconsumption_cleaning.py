...
#GOAL: Use pandas to import state energy consumption data into dataframe
...
def main():
    ...
    #import energy consumption csv
    #NOTE: Link active as of 10.30.2019
    ...
    energy_states = energy[~energy.State.isin(badstates)]
    ...
    def make_cat_list(col_index, list_categories, counter):
        '''
    ...
    desired_cols = [19, 106, 130, 48, 141, 168, 163, 166, 161, 7, 31, 110]
    col_pos = 2
    counter = 0
    while counter < len(desired_cols):
        make_cat_list(desired_cols[counter], list_categories, counter)
        counter += 1
    ...
    export_csv = energy_v1.to_csv('EIA_State_Consumption_1960-2017_clean.csv', index = None, header=True)
...
if __name__ == '__main__':
    ...
    print("Calling energyconsumption_cleaning.py -> main() ")
    main()